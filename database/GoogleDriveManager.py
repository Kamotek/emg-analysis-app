...
class GoogleDriveManager:
    def __init__(self, settings_file='drive_settings.yaml', folder_name='EMG Analysis Data'):
        ...
        self.folder_id = self.ensure_app_folder()

    def authenticate_persistently(self):
        credentials_file = self.gauth.settings.get('save_credentials_file')
        assert credentials_file, 'Credentials file path not set in settings file'
